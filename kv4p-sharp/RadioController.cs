...
public class RadioController : IDisposable
{
    ...
    private const int baudRate = 230400;//ddd 921600;
    ...
    private const int AUDIO_SAMPLE_RATE = 16000;//ddd 44100;
    ...
    /// <param name="BW">12.5 or 25 K (N or W).</param>
    public void TuneToFrequency(string txFrequencyStr, string rxFrequencyStr, int tone, int squelchLevel, string BW)
    {
        ...
        string paramsStr = txFrequencyStr + rxFrequencyStr + toneStr + squelchStr + BW;//ddd added "N" or "W"

        Debug.Print(paramsStr);//ddd
    ...
    private string MakeSafe2MFreq(string strFreq)
    {
        ...
        {
            freq = 146.5200f; // Default frequency //ddd was 146.520f
        }

        while (freq > 174.0f) //ddd was 148
        {
            freq /= 10f;
        }

        freq = Math.Min(freq, 174.0f); //ddd was 148
        freq = Math.Max(freq, 134.0f); // ddd was 144

        string formattedFreq = freq.ToString("000.0000", System.Globalization.CultureInfo.InvariantCulture); //ddd was 000.000
